...
function showTable(contacts) {
    ...
    if (contacts.length === 0) {
        ...
        contacts.forEach(contact => {
            ...
            editButton.classList.add("col", "action-button-e");
            ...
            editButton.onclick = function() {
                if (editButton.textContent === "Edit") {
                    ...
                    // Update the database
                    updateContact(contactId, newName, newPhone, newEmail);
            ...
            deleteButton.classList.add("col", "action-button-d");
            deleteButton.textContent = "Delete";
            deleteButton.setAttribute("data-name", contact.Name);
            deleteButton.setAttribute("data-user-id", contact.ID);
...
function updateContact(id, newName, newPhone, newEmail) {
    ...
    let jsonPayload = JSON.stringify(payload);
    console.log("Updating contact payload:", jsonPayload); // Log the payload
